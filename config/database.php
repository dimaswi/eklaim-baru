    ...
    */
    ...
    'connections' => [
        ...
        'aplikasi' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_HOST_APLIKASI', '127.0.0.1'),
            'port' => env('DB_PORT_APLIKASI', '3306'),
            'database' => env('DB_DATABASE_APLIKASI', 'laravel'),
            'username' => env('DB_USERNAME_APLIKASI', 'root'),
            'password' => env('DB_PASSWORD_APLIKASI', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
        ...
        'layanan' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_HOST_LAYANAN', '127.0.0.1'),
            'port' => env('DB_PORT_LAYANAN', '3306'),
            'database' => env('DB_DATABASE_LAYANAN', 'laravel'),
            'username' => env('DB_USERNAME_LAYANAN', 'root'),
            'password' => env('DB_PASSWORD_LAYANAN', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
        ...
        'medicalrecord' => [
            ...
            'database' => env('DB_DATABASE_RM', 'laravel'),
            'username' => env('DB_USERNAME_RM', 'root'),
        ...
        'eklaim' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_HOST_EKLAIM', '127.0.0.1'),
            'port' => env('DB_PORT_EKLAIM', '3306'),
            'database' => env('DB_DATABASE_EKLAIM', 'laravel'),
            'username' => env('DB_USERNAME_EKLAIM', 'root'),
            'password' => env('DB_PASSWORD_EKLAIM', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
        ...
        'pembayaran' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_HOST_PEMBAYARAN', '127.0.0.1'),
            'port' => env('DB_PORT_PEMBAYARAN', '3306'),
            'database' => env('DB_DATABASE_PEMBAYARAN', 'laravel'),
            'username' => env('DB_USERNAME_PEMBAYARAN', 'root'),
            'password' => env('DB_PASSWORD_PEMBAYARAN', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
