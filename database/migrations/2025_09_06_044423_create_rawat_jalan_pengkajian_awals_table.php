...
return new class extends Migration
{
    ...
    {
        Schema::connection('app')->create('rawat_jalan_pengkajian_awals', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('metode_nyeri')->nullable();
            ...
            $table->index(['pengajuan_klaim_id', 'kunjungan_nomor'], 'rawat_jalan_pengkajian_klaim_kunjungan_idx');
        });
    }
