...
export default function RawatInapResumeMedis() {
    ...
    const handleLoadResumeMedis = async () => {
        setLoading('load');
        try {
            const response = await fetch(`/eklaim/rawat-inap/resume-medis/${kunjungan.NOMOR}`);
        ...
        try {
            const dataToSend = {
                ...
                pasien: {
                    ...
                    ruangan: String(pasien.ruangan || ''),
                    penanggung_jawab: String(pasien.penanggung_jawab || ''),
                    dokter: String(pasien.dokter || ''),
                    petugas: String(pasien.petugas || ''),
                    ...
                    tanggal_masuk: pasien.tanggal_masuk && pasien.tanggal_masuk !== 'Tidak ada' && pasien.tanggal_masuk !== 'Tidak Diketahui' ? pasien.tanggal_masuk : null,
