    ...
    const handleSimpanPengkajianAwal = async () => {
        ...
        try {
            const dataToSend = {
                ...
                tanggal_lahir: pasien.tanggal_lahir && pasien.tanggal_lahir !== 'Tidak ada' && pasien.tanggal_lahir !== '' ? pasien.tanggal_lahir : null,
                tanggal_masuk: pasien.tanggal_masuk && pasien.tanggal_masuk !== 'Tidak ada' && pasien.tanggal_masuk !== '' ? pasien.tanggal_masuk : null,
                tanggal_keluar: pasien.tanggal_keluar && pasien.tanggal_keluar !== 'Tidak ada' && pasien.tanggal_keluar !== '' ? pasien.tanggal_keluar : null,
                selected_diagnosa: JSON.stringify(selectedDiagnosa),
            };

            router.post(`/eklaim/rawat-jalan/pengkajian-awal`, dataToSend, {
                onSuccess: () => {
                    toast.success('Data Pengkajian Awal Rawat Jalan berhasil disimpan');
                    setLoading(null);
                },
                onError: (errors) => {
            ...
            <div className="max-w-7xl p-4">
                <div className="mb-4 flex items-center justify-end gap-2">
                    ...
                    <Button
                        ...
                        onClick={handleSimpanPengkajianAwal}
                    >
